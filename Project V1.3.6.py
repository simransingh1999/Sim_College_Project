...
def buildSystem():
    ...
    def createOrder(frame):
        ...
        typeEntry = ttk.Entry(frame)
        typeEntry.grid(column=2, row=1, sticky=(N))
        typeEntry.insert(END, "Please Select...")
        
        meatPart = ttk.Label(frame, text="Part of Meat:")
        meatPart.grid(column=0, row=3, sticky=(N))
        partEntry = ttk.Entry(frame)
        partEntry.grid(column=2, row=3, sticky=(N))
        partEntry.insert(END, "Please Select...")
