...
def createOrders(frame):
    ...
    add = Button(frame, text="Add Order")
    add.grid(column=1, row=0, sticky=(N))
    delete = Button(frame, text="Delete Order")
    delete.grid(column=3, row=0, sticky=(N))
    view = Button(frame, text="View Orders")
    view.grid(column=5, row=0, sticky=(N), padx=5)
    profit = Button(frame, text="Profit: ")
    profit.grid(column=1, row=1, sticky=(N), pady=10)
    revenue = Button(frame, text="Revenue: ")
    revenue.grid(column=1, row=3, sticky=(S))
